...
addressBook.addContact("bhagyodaya", "varshney", "Mathura", "CityName", "UttarPradesh", "281001", "1234567890", "bhagya@gmail.com");
addressBook.addContact("Anuj", "choudhary", "Mathura", "CityName", "UttarPradesh", "281001", "1234567890", "anuj@gmail.com");
addressBook.addContact("Swapnil", "Sharma", "Mathura", "CityName", "UttarPradesh", "281001", "1234567890", "Swapnil@gmail.com");
addressBook.addContact("Arush", "kumar", "Mathura", "CityName", "UttarPradesh", "281001", "1234567890", "Arush@gmail.com");
console.log(JSON.stringify(addressBook.contacts));
console.log();

addressBook.findAndEditContact("kunal",{city: "NewCity", phone: "9876543210"});
console.log(JSON.stringify(addressBook.contacts,null,2));

addressBook.findAndDeleteContact("Anuj");
console.log(JSON.stringify(addressBook.contacts,null,2));
